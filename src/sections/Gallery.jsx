...
const sites = [
  { image: project1, title: "Personal Portfolio", desc: "Stand out as a professional—display your projects, expertise, and achievements on a portfolio that wows" },
  { image: project2, title: "Blog Platform", desc: "Share stories and insights with a modern, media-rich blog built for engagement and discovery" },
  { image: project3, title: "Magazine", desc: "Deliver news, reviews, and stories in a clean editorial format—perfect for teams and creators alike" },
  { image: project4, title: "E-Commerce Store", desc: "Launch a clean, conversion-focused shop to showcase and sell products with ease" },
  { image: project5, title: "Fashion/Brand Landing Page", desc: "Present your brand or products with a bold, interactive landing page that inspires immediate action" },
  { image: project6, title: "Travel Website", desc: "Plan your next adventure with a captivating travel site—showcase trips, destinations, and tips in style" },
];

function FlipCard({ site }) {
  return (
    <div className="perspective cursor-pointer group">
      <div className="relative w-full h-72 transition-transform duration-500 transform-style-preserve-3d group-hover:rotate-y-180">
        ...
        <div className="absolute w-full h-full bg-[#111827] rounded-xl shadow-lg border border-[#222] flex flex-col justify-center items-center px-6 backface-hidden">
          ...
          <span className="mt-7 text-xs text-gray-600">Hover to preview</span>
        </div>
